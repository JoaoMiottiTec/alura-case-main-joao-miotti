...
class RegistrationReportApiTest {
  ...
  void report_returns_desc_by_registrations() throws Exception {
    RegistrationReportItem item1 =
        new Item("Java Fundamentals", "JAVA01", "Ana Silva", "ana@alura.com", 7L);
    RegistrationReportItem item2 =
        new Item("Spring Boot API", "SPR02", "Bruno Lima", "bruno@alura.com", 3L);
  ...
  void report_uses_name_asc_as_tiebreaker_when_counts_equal() throws Exception {
    RegistrationReportItem a = new Item("Algorithms", "ALG1", "Ana Silva", "ana@alura.com", 5L);
    RegistrationReportItem z = new Item("Zebra Course", "ZEB1", "Ana Silva", "ana@alura.com", 5L);
