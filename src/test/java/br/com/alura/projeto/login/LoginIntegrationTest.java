...
class LoginIntegrationTest {
    ...
    void home_semFiltro_ok() throws Exception {
        ...
        CourseDTO spring = new CourseDTO(
                1L, "Spring Boot", "SPRING-BOOT", "instrutor@alura.com",
                "Back-end", "API REST", "ACTIVE"
        );
        CourseDTO react = new CourseDTO(
                2L, "React", "REACT", "instrutor@alura.com",
                "Front-end", "SPA", "ACTIVE"
        );
        ...
        mockMvc.perform(get("/"))
                ...
                .andExpect(model().attribute("courses", everyItem(allOf(
    ...
    void home_comFiltro_ok() throws Exception {
        ...
        mockMvc.perform(get("/").param("category", "Back-end"))
                .andExpect(status().isOk())
                .andExpect(view().name("login"))
